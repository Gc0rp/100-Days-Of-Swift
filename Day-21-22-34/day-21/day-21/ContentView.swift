                ...
                VStack(spacing: 15) {
                    ...
                    ForEach(0..<3) { number in
                        Button {
                            ...
                            FlagImage(flagName: countries[number]).rotation3DEffect(.degrees(flagPosition == number ? animationAmount: 0), axis: (x: 0, y: 1, z: 0)).opacity((flagPosition != number) ? notSelected : 1).rotation3DEffect(.degrees(flagPosition != number ? animationAmount: 0), axis: (x: 1, y: 0, z: 0))
                        }
                    }
